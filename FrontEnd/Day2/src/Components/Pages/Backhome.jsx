  ...
  return (
    ...
    <div className='home-b'>
      ...
      <nav className='home-nav'>
        <div className="menu">
          ...
          <ul className='home-ul'>
            <li><a className="active1" href="/Backhome">Home</a></li>
            {/* <li><a href="/BookEvents">Enroll course</a></li> */}
            <li><a href="Addacademy">Academy</a></li>
            <li><a href="Course">Course</a></li>
            <li><a href="Addapplicant">Students</a></li>
      ...
      >
        ...
        <div className="h-img2">
        <h1 className='h1-tag'>
        <center>  La masia-Madrid Academy!</center>
</h1>  
        <Footer/>
        </div>
        </div>
