            ...
            <div className="modal-container">
                ...
                <div className="evnt-create-box">
                    <div className=''>
                        ...
                        <h1 className='eb-h1'>Add Applicant:</h1><br></br>
                        <div className='event-details'>
                          ...
                          <Link to="/Backhome"> <button className='create-button' >Add Applicant</button></Link>
                          <Link to="/Updateapplicant"> <button className='create-button' >Update Applicant</button></Link>
                            </div>
