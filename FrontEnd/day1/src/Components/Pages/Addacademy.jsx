                ...
                <div className="evnt-create-box">
                    <div className=''>
                        ...
                        <div className='event-details'>
                          ...
                          <Link to="/Backhome"> <button className='create-button' >Add Academy</button></Link>
                          <Link to="/Updateacademy"> <button className='create-button' >Update Academy</button></Link>
                            </div>
